    ...
    return (
        <div className={footerStyles.footer}>
            <p>
                ...
                <a href='https://open.spotify.com/user/dirgfk4e07s0pggwbexjxmjbw?si=e0fe017022114a1e' target='_blank' className={footerStyles.social} rel='noreferrer'><FaSpotify /></a>
